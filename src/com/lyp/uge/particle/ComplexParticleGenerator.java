...
public class ComplexParticleGenerator {
	...
	public ComplexParticleGenerator(float pps, float speed, float gravityComplient, float lifeLength, float scale, ParticleTexture texture) {
        this.pps = pps;
        this.averageSpeed = speed;
        this.gravityFactor = gravityComplient;
        this.averageLife = lifeLength;
	...
	public void setLifeError(float error) {
		this.lifeError = error * averageLife;
	}
	...
	private void emitParticle(Vector3f center) {
		...
		float lifeLength = generateValue(averageLife, lifeError);
		new Particle(mParticleTexture, new Vector3f(center), velocity, gravityFactor, lifeLength, generateRotation(), scale);
	}
